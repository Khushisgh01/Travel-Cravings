...
module.exports.listingSchema = Joi.object({
    listing: Joi.object({
        ...
        // NEW: category powers the working filter bar on the index page.
        // allow("", null) so old forms / partial submits don't break validation —
        // the Mongoose schema default ("trending") kicks in if it's empty.
